...
#
#
grid = [0,0,0,0,-6,0,0,0,0,0,0,0,-4,0,-9,0,0,0,0,0,-9,-7,0,-5,-1,0,0,0,-5,-2,0,-7,0,-8,-9,0,-9,0,0,-5,0,-2,0,0,-4,0,-8,-3,0,-4,0,-7,-2,0,0,0,-1,-2,0,-8,0,0,
                                     3,0,-3,0,0,0,0,0,0,0,-6,0,-4,0,0,0,-8,0,-7,0,0,0,0,0,0,0,-5,0,0,0,0,-1,0,-6,-3,0,0,0,-9,-8,0,-5,0,-1,-2,0,-2,0,0,-7,0,-1,0,0,-3,0,-4,-3,0,-8,0,-6,-5,0,0,0,-7,-3,0,-5,-9,0,0,0,0,0,-4,0,-2,0,0,0,0,0,0,0,-6,0,0,0,0]
#
...
for i in range(0, 17):
    ...
    if i<6 or i>=11:
        for j in range(0, 9):
            tests.append(test[i*9+j])
        newTest.append(tests)
    elif i==6:
        for j in range(15):
            tests.append(test[54+j])
        newTest.append(tests)
    elif i==7:
        for j in range(15):
            tests.append(test[69+j])    
        newTest.append(tests)
    elif i == 8:
        for j in range(15):
            tests.append(test[84+j])    
        newTest.append(tests)
