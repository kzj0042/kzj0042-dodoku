...
def calculateHash(grid):
    ...
    for i in range(107, 156, 9):
        strColOrder+=str(grid[i])  
    strColOrder = "0-800-50-200-200-30000-40-100-900-600-90000-60-5-10-300000-70000000-30000-40-20000-2-70-40-40-100-8000000-50-60-50-6-70300-60-90000-200000-60-100000-90-5-40-70000-300-100-400-90-600-90000-30-9-50-8000-1"
    hashobj = hashlib.sha256(strColOrder.encode())
    print(hashobj.hexdigest())
    randomNumber = random.randrange(len(hashobj.hexdigest())-7)
    return hashobj
