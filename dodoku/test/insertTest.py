...
class InsertTest(TestCase):
        ...
        def test_004_ShouldInsertIntoLevel3Grid(self):
            ...
            parms = {'op':'insert', 'cell':'r7c9', 'value':'1', 'grid':grid, 'integrity':create.calculateHash(grid)}
            actualResult = insert._insert(parms)              
            expectedGrid = {'grid': [0,0,0,0,-6,0,0,0,0,0,0,0,-4,0,-9,0,0,0,0,0,-9,-7,0,-5,-1,0,0,0,-5,-2,0,-7,0,-8,-9,0,-9,0,0,-5,0,-2,0,0,-4,0,-8,-3,0,-4,0,-7,-2,0,0,0,-1,-2,0,-8,0,0,1,0,-3,0,0,0,0,0,0,0,-6,0,-4,0,0,0,-8,0,
            ...
            expectedStatus = {'status':'ok'}
            expectedHash = "c6d6b0ff7f987946e204b4d5ff53289751ecede3ad45a16aa01bc553d08df8aa"
            actualGrid = {'grid':actualResult['grid']}
            actualStatus = {'status':actualResult['status']}
            actualHash = actualResult['integrity']
            self.assertDictEqual(expectedGrid, actualGrid)
