...
class RecommendTest(TestCase):
        ...
        def test_110_ShouldNotInsertValueNegativeRow(self):
            ...
            parms = {'op':'recommend', 'cell':'r-1c5', 'value':'3', 'grid':grid, 'integrity':calculteHash.getEightCharactersOfHash(calculteHash.calculateHash(grid))}      
            actualResult = recommend._recommend(parms)
